  ...
  const [chatHistories, setChatHistories] = useState<ChatHistory[]>([
    {
      ...
      messages: [
        ...
        {
          role: 'assistant',
          content: 'I\'d recommend Hill\'s Science Diet Sensitive Stomach & Skin Adult Dog Food. It\'s specially formulated for digestive health and currently 20% off. Would you like to see the details?',
